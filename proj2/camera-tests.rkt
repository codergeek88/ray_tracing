...
;; CHECK TESTS
(check-within (make-camera 400 200 1 fl3-zero (Float3 -1.0 0.5 0.0)
                           fl3-zero 90.0)
              (Camera 400 200 1 fl3-zero (fl3-normalize (Float3 -1.0 0.5 0.0))
                      fl3-zero fl3-zero)
              0.01)

(check-within (make-camera 200 200 10 fl3-zero (Float3 -1.0 0.0 0.0)
                           fl3-zero 90.0)
              (Camera 200 200 10 fl3-zero (fl3-normalize (Float3 -1.0 0.0 0.0))
                      fl3-zero fl3-zero)
              0.01)
